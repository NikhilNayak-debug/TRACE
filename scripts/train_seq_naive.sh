...
deepspeed --include=localhost:0,1,2,3,4,5,6,7 --master_port $port training/main.py  \
    --data_path /workspace/TRACE/TRACE-Benchmark/LLM-CL-Benchmark_500 \
    ...
    --print_loss \
    --CL_method base \
    --output_dir /workspace/TRACE/outputs_LLM-CL/naive > /workspace/TRACE/outputs_LLM-CL/naive/train.log 2>&1 &
